...
class PageTwo: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let rect = CGRect(x: 100, y: 30, width: SCREENWIDTH - 200, height: 60) // CGFloat, Double, Int
        let label = UILabel()
        label.frame = rect
        ...
        imageView.frame = CGRect(x: 50, y: 200, width: SCREENWIDTH - 100, height: 350)
        imageView.image = UIImage.init(named: "tour_3_screen_Image.png")
